...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.example.tabapplication.ui.main.helper.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.example.tabapplication.ui.main.helper.GlideOptions().apply(toSet));
    }
  }
}
